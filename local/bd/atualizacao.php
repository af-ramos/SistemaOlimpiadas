...
if (isset($_POST['botaoEnviar'])) {
    ...
    $comando = "UPDATE local SET nome = '$nome', capacidade = '$capacidade', endereco = '$endereco', pais_codigo = '$pais' WHERE codigo = $idAt;";
...
$comandoDados = "SELECT * FROM local WHERE codigo = '$idAt'";
    ...
    <div class="m-3">
        ...
        <form action="atualizacao.php?idAt=<?php echo $idAt ?>" method="POST">
            <div class="input-group mb-3">
                ...
                <input type="number" class="form-control" name="codigo" required readonly value="<?php echo $tuplaDados['codigo'] ?>">
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text">Capacidade</span>
                <input type="number" class="form-control" name="capacidade" required value="<?php echo $tuplaDados['capacidade'] ?>">
            </div>
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="endereco" required value="<?php echo $tuplaDados['endereco'] ?>">
            </div>
