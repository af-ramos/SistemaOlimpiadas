...
<head>
    <title> Cadastro e Consulta de Olímpiadas </title>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#botaoPrimeiro").click(function() {
                $.ajax({
                    type: 'POST',
                    url: 'bd/ajaxConsulta.php',
                    data: {
                        tipoConsulta: "Primeiro",
                        valorConsulta: document.getElementById("textoConsulta").value
                    },
                    success: function(data) {
                        document.getElementById("tabelaConteudo").innerHTML = data;
...
<body style="width: 100%">
    ...
    <div class="m-3">
        ...
        <div class="input-group mb-3">
            ...
            <button class="btn btn-dark" type="button" id="botaoPrimeiro">por primeiro lugar</button>
        ...
        if (isset($_SESSION["sucessoPodio"])) {
            echo "<div class='alert alert-success'> " . $_SESSION["sucessoPodio"] . "</div>";
            unset($_SESSION["sucessoPodio"]);
        }

        if (isset($_SESSION["erroPodio"])) {
            echo "<div class='alert alert-danger'> " . $_SESSION["erroPodio"] . "</div>";
            unset($_SESSION["erroPodio"]);
        }
        ?>
    </div>
</body>
