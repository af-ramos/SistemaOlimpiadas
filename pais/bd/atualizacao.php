...
$codigoAt = $_GET['codigoAt'];

if (isset($_POST['botaoEnviar'])) {
    $nome = $_POST["nome"];

    $comando = "UPDATE pais SET nome = '$nome' WHERE codigo = '$codigoAt';";
...
$comando = "SELECT * FROM pais WHERE codigo = '$codigoAt'";
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item btn">
                        <a class="nav-link active" href="../../pais/pais.php">País</a>
                    </li>
                    <li class="nav-item btn">
    ...
    <div class="m-3">
        ...
        <form action="atualizacao.php?codigoAt=<?php echo $codigoAt ?>" method="POST">
            <div class="input-group mb-3">
                <span class="input-group-text">Código</span>
                <input type="text" class="form-control" name="codigo" readonly value="<?php echo $tupla['codigo']; ?>"> <br>
            </div>

            <div class="input-group mb-3">
                <span class="input-group-text">Nome</span>
                <input type="text" class="form-control" name="nome" required value="<?php echo $tupla['nome']; ?>"> <br>
            </div>
