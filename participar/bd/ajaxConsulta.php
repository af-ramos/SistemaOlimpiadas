...
if (isset($_POST["valorConsulta"])) {
    ...
    if ($valorConsulta == "") {
        ...
        $comando = "SELECT olimpiada.nome AS olimpiadaNome, pais.nome AS paisNome, pais.codigo AS paisCodigo, olimpiada.ano AS olimpiadaAno FROM participar 
                    INNER JOIN olimpiada ON participar.olimpiada_nome = olimpiada.nome 
                    INNER JOIN pais ON pais.codigo = participar.pais_codigo WHERE pais.nome LIKE '%$valorConsulta%'";
    } else {
        $comando = "SELECT olimpiada.nome AS olimpiadaNome, pais.nome AS paisNome, pais.codigo AS paisCodigo, olimpiada.ano AS olimpiadaAno FROM participar 
                    INNER JOIN olimpiada ON participar.olimpiada_nome = olimpiada.nome 
                    INNER JOIN pais ON pais.codigo = participar.pais_codigo WHERE olimpiada.nome LIKE '%$valorConsulta%'";
    }
