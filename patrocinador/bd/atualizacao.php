...
if (isset($_POST['botaoEnviar'])) {
    ...
    $comando = "UPDATE patrocinador SET nome = '$nome' WHERE idEmpresa = $idAt;";
...
$comandoDados = "SELECT * FROM patrocinador WHERE idEmpresa = '$idAt'";
...
<head>
    <title> Atualização de Patrocinador </title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item btn">
                        <a class="nav-link active" href="../../patrocinador/patrocinador.php">Patrocinador</a>
                    </li>
                    <li class="nav-item btn">
    ...
    <div class="m-3">
        ...
        <form action="atualizacao.php?idAt=<?php echo $idAt ?>" method="POST">
            <div class="input-group mb-3">
                ...
                <input type="number" class="form-control" name="id" required readonly value="<?php echo $tuplaDados['idEmpresa'] ?>">
            </div>
